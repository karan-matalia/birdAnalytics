...
"""
This Class is used to generate a common report for all months in the time frame given. For example if the given range
in the csv file is from Jan 2018 to Jun 2020 then it will create a single image for Jan '18, Jan '19 and Jan '20,
and similarly for all other months.
"""


class CommonMonths(object):
    ...
    def data_cleanup(self):
        ...
        self.bird_df['MONTH'] = self.bird_df['OBSERVATION_DATETIME'].dt.month
        self.bird_df.sort_values(by=['MONTH'], inplace=True)
        self.column_length = self.bird_df['MONTH'].shape[0]
        self.current_month = self.bird_df['MONTH'].iloc[0]
    ...
    def data_visualization(self):
        ...
        for i in range(self.column_length):
            month = self.bird_df['MONTH'].iloc[i]
    ...
    def create_new_basemap(self):
        ...
        plt.annotate(str(self.bird_name) + ' : ' + str(self.current_month_name), xy=(0, 1.03),
    ...
    def save_figure(self):
        folder_name = self.current_dir + '/images/' + 'CommonMonths- ' + str(self.bird_name)
        figure_name = folder_name + '/' + str(self.bird_name) + '-' + get_month_digit_formatted(
            str(self.current_month)) + '.png'
    ...
    def generate_gif(self):
        folder_name = self.current_dir + '/gifs/' + 'CommonMonths- ' + str(self.bird_name)
